...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        WindowHint.windowHint_Allow_Resize.setValue(true);
        Engine.launch(600, 600, args); //launch the engine and create a window with height 600 and width 600
        ...
        Engine.addEvent(new SlythrEvent() {
            ...
            public boolean trigger() {
                return game_window.input_array.contains("f");
            }
        ...
        particle.setPrimitive(samplerect);
